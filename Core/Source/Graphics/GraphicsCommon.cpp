...
void InitializeCommonState() {
	...
	RasterizerDefault.FrontCounterClockwise = TRUE;		// Note: we use right hand system.
	...
	//
	// Create depth stencil descriptions.
	//
	...
	DepthStateReadWrite.DepthFunc = D3D12_COMPARISON_FUNC_GREATER_EQUAL;	// Note: use greater equal for reverse Z.
	...
	DepthStateReadOnlyReversed.DepthFunc = D3D12_COMPARISON_FUNC_LESS;		// Note: common depth mode, none reverse Z.
